...
def teste2():
    ...
    return render_template('teste2.html',disciplinas=disciplinas,total_users=total_users,nome_from=nome_from)
...
def msg_chat_enviar():
    nome_from = request.form['nome_from']
    evento_chat = request.form['evento_chat']
    ...
    try:
        connection_pusher(evento_chat,dicio)
